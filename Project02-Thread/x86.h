...
struct trapframe {
  ...
  uint edx;       // Register used with eax, to extend sign bit
  uint ecx;       // Register to count loop
  uint eax;       // Reigster to save the retrun value of function
  ...
  uint esp;       // Register of Stack Pointer
  ushort ss;
  ushort padding6;
};
